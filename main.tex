...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Languages:}{ Python, Bash, Java, C/C++, SQL} \\ \vspace{3pt}

        \textbf{Data Science:}{ Sklearn, Pytorch, Tensorflow, Data Preprocessing, Data Analytics, NLP, Computer Vision, Generative AI, Forecasting, Anomaly Detection} \\ \vspace{3pt}

        \textbf{Oracle Cloud:}{ OCI, OCI Data Science, E-Business Suite} \\ \vspace{3pt}

        \textbf{Web Development:}{ HTML, CSS, Javascript, React.js, Flask, Django, FASTAPI, OJET } \\ \vspace{3pt}

        \textbf{Collaboration:}{ Git, Jira, DevOps, Docker, Kubernetes} \\ \vspace{3pt}

        \textbf{Soft Skills:}{ Communication, Collaboration, Leadership, Critical Thinking, Adaptability} \\ \vspace{3pt}

        \textbf{Other Skills:}{ High Level Design, Selenium, Streamlit} \\ \vspace{3pt}
...
\section{Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Oracle}{Jan 23 \textbf{--} Present, Full-time}
        \resumeItemListStart
            \resumeItem{Developed predictive models for server outage forecasting using time series data, including CPU utilization, memory, disk usage, and other server metrics.}
            
            \resumeItem{Conducted a thorough literature review on Time Series Forecasting and implemented LSTM, GRU, Bidirectional LSTM, ARIMA and Prophet models to predict future resource utilization (CPU, memory, disk) and chose the best model for the use case, optimizing the accuracy of outage predictions.}
        
            \resumeItem{Improved model performance by 25\% through hyperparameter tuning.}
            
            \resumeItem{
            Managed large-scale data (over 50,000 lines per server) for time series prediction, optimizing model training using Oracle Cloud Infrastructure Components.}
            
            \resumeItem{
           Leveraged advanced models like Informer and Transformer architectures to handle long-term forecasting challenges, improving the ability to detect future anomalies and prevent outages by 25\%.}

           \resumeItem{
            Developed an BERT based Customer Call-back Sentiment Analysis system which reduced the 500 man hours annually. Enabled sentence-level analysis and created a centralized repository for recurring issues, providing immediate attention to high-priority concerns. This solution enhanced the customer experience by 40\% and reduced customer escalation by 50\%, significantly improving overall customer satisfaction and operational efficiency.}
            
        \resumeItemListEnd

    \resumeSubheading
      {Software Developer 2}{Bangalore, India}
      {Oracle}{Aug 22 \textbf{--} Present, Full-time}
        \resumeItemListStart
            ...
            \resumeItem{
           Served as Data Analyst and developed graphical representations and conducted in-depth data analysis for workflow improvements, improving decision-making processes and providing actionable insights for the team.}
            
        \resumeItemListEnd

    \resumeSubheading
      {Freelancer}{Erode, India}
      {Upworks}{June 2019 \textbf{--} June 2022, Part-time}
        \resumeItemListStart
            \resumeItem{\textbf{Content Writing:} Produced over 150 articles and tutorials on Cyber Security, Data Science, Web Scraping, Python, and Java, driving engagement for multiple tech companies.}
            \resumeItem{\textbf{Content Creation:} Developed more than 50 video tutorials for Augmented Startups' YouTube channel, amassing over 100,000 views on Data Science and Java content.}
            \resumeItem{\textbf{Private Tutoring:} Delivered personalized tutoring to over 30 students, covering Computer Networks, DSA, Java, Python, and C++ with a 90\% student satisfaction rate.}
            \resumeItem{\textbf{Data Science Projects:} Executed computer vision, data analysis, and natural language processing (NLP) projects foExecuted 20+ Data Science projects, including computer vision, data analysis, and NLP solutions for clients ranging from startups to enterprises.}
            \resumeItem{\textbf{Web Development:} Completed 10+ web scraping projects, gathering critical data for businesses with 95\% accuracy and efficiency. Built 15+ static and dynamic websites, ensuring timely delivery and client satisfaction.}
            \resumeItem{\textbf{Freelance Success:} Accumulated over 1000 hours of freelance work with 100\% Job Success rate on Upwork.}
        \resumeItemListEnd
...
\section{Projects}
    ...
    \resumeProjectHeading
        {\textbf{Predictive Server Monitoring and Outage Prediction} $|$ \emph{\href{https://oracle.com/cloud}{\color{blue}Oracle}}}{Apr 24}
          \resumeItemListStart
            \resumeItem{Designed and implemented machine learning models to anticipate server outages by forecasting resource utilization. Trained on multi-server data to create a scalable solution, handling diverse server environments and predicting resource usage for each. Reduced server downtime by detecting anomalies and predicting potential failures based on trend analysis and advanced feature engineering. Leveraged Oracle Cloud's high-performance computing capabilities, optimizing resource allocation and accelerating training times for large datasets.}
          \resumeItemListEnd

    \resumeProjectHeading
        {\textbf{AI integrated Data Analysis Dashboard} $|$ \emph{\href{https://oracle.com/cloud}{\color{blue}Oracle}}}{Aug 23}
          \resumeItemListStart
    ...
    \resumeProjectHeading
        {\textbf{BIOTIK} $|$ \emph{\href{https://github.com/hruthiksiva/biotik}{\color{blue}GitHub}}}{April 22}
          \resumeItemListStart
            \resumeItem{Developed the BIOTIK website using React.js, focusing on UI/UX design and advanced security features. Achieved a 30\% increase in user engagement and a 25\% boost in customer satisfaction by delivering a seamless and intuitive user experience. Enhanced website performance, reducing load times by 40 \%, ensuring faster access and improved overall customer convenience.}
          \resumeItemListEnd
      
      \resumeProjectHeading
        {\textbf{Airshine Online} $|$ \emph{\href{https://github.com/hruthiksiva/airshineonline}{\color{blue}GitHub}}}{Jan 22}
          \resumeItemListStart
            \resumeItem{Developed the Airshine Online travel company website using React.js, focusing on UI/UX design and advanced security features. Achieved a 30\% increase in user engagement and a 25\% boost in customer satisfaction by delivering a seamless and intuitive user experience. Enhanced website performance, reducing load times by 40 \%, ensuring faster access and improved overall customer convenience.}
          \resumeItemListEnd
