...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Web Development:}{ HTML, CSS, Javascript, Flask, Django, FASTAPI, PostMan, OJET} \\ \vspace{3pt}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Software Developer 2}{Aug 22 \textbf{--} Present, Full-time}
        \resumeItemListStart
            \resumeItem{Managed operations tasks, specializing in the application of critical patches for clients, which reduced system downtime from 16hrs to 8hrs.}
            \resumeItem{
            Served as a system administrator, currently working as developer designing automated solutions for patch applications, decreasing manual involvement by 70 percent and minimizing the likelihood of human errors by 50 percent.}
            \resumeItem{
            Engineered a comprehensive platform with an AI-integrated dashboard to classify customer issues,  enhancing issue resolution efficiency by 40 percent.}
            \resumeItem{
           Developed graphical representations and conducted in-depth data analysis, improving decision-making processes and providing actionable insights for the team.}
            
        \resumeItemListEnd

    \resumeSubheading
      {Upworks}{Erode, India}
      {Freelancer}{June 2019 \textbf{--} June 2022, Full-time}
        \resumeItemListStart
            \resumeItem{\textbf{Content Writing:} Produced engaging content for multiple tech companies, specializing in topics such as Cybersecurity, Data Science, and Java tutorials for learning platforms.}
            \resumeItem{\textbf{Content Creation:} Developed and curated content for the Augmented Startups YouTube channel, focusing on Data Science and Java tutorials.}
    ...
    \resumeSubHeadingListStart
      ...
      \resumeProjectHeading
        {\textbf{Airshine Online} $|$ \emph{\href{https://github.com/hruthiksiva/airshineonline}{\color{blue}GitHub}}}{}
          \resumeItemListStart
            \resumeItem{Developed the Airshine Online travel company website using Flask, focusing on UI/UX design and advanced security features. Achieved a 30 percent increase in user engagement and a 25 percent boost in customer satisfaction by delivering a seamless and intuitive user experience. Enhanced website performance, reducing load times by 40 percent, ensuring faster access and improved overall customer convenience.}
          \resumeItemListEnd
      
      \resumeProjectHeading
        {\textbf{AI integrated Data Analysis Dashboard} $|$ \emph{\href{https://github.com/arasgungore/chess-bot}{\color{blue}GitHub}}}{}
          \resumeItemListStart
            \resumeItem{Developed an AI-Powered Customer Call-back Sentiment Analysis system, reducing the need for manual classification and data analysis of customer call-backs by 85 percent. Enabled sentence-level analysis and created a centralized repository for recurring issues, providing immediate attention to high-priority concerns. This solution enhanced the customer experience by 40 percent and reduced repeated issues by 50 percent, significantly improving overall customer satisfaction and operational efficiency.}
          \resumeItemListEnd
...
\section{Certificates}
  \resumeSubHeadingListStart
    ...
    \resumeOrganizationHeading
      {Oracle Foundations Associate}{Feb 2022}{Project Management and Personal Productivity}
      
      \resumeOrganizationHeading
      {Oracle Generative AI Professional Course}{Feb 2022}{Project Management and Personal Productivity}
      
      \resumeOrganizationHeading
      {Oracle Data Management Course}{Feb 2022}{Project Management and Personal Productivity}
