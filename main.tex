...
\section{Skills}
  ...
  \resumeSubHeadingListStart
    \small{\item{
        ...
        \textbf{Data Science:}{ Pytorch, Tensorflow, Data Analytics, NLP, Computer Vision, Generative AI, Forecasting} \\ \vspace{3pt}
...
\section{Experience}
  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      {Oracle}{Aug 23 \textbf{--} Present, Full-time}
        \resumeItemListStart
            ...
            \resumeItem{Implemented LSTM, GRU, Bidirectional LSTM, ARIMA and Prophet models to predict future resource utilization (CPU, memory, disk) with a horizon of 500-1000 steps, optimizing the accuracy of outage predictions.}
        
            \resumeItem{Improved model performance by 25\% through hyperparameter tuning, using dropout layers, and exploring activation functions like ReLU and tanh for forecasting tasks.}
            ...
            \resumeItem{
           Leveraged advanced models like Informer and Transformer architectures to handle long-term forecasting challenges, improving the ability to detect future anomalies and prevent outages.}
...
\section{Projects}
    ...
    \resumeProjectHeading
        {\textbf{BIOTIK} $|$ \emph{\href{https://github.com/hruthiksiva/biotik}{\color{blue}GitHub}}}{April 23}
          \resumeItemListStart
            \resumeItem{Developed the BIOTIK website using Flask, focusing on UI/UX design and advanced security features. Achieved a 30\% increase in user engagement and a 25\% boost in customer satisfaction by delivering a seamless and intuitive user experience. Enhanced website performance, reducing load times by 40 \%, ensuring faster access and improved overall customer convenience.}
          \resumeItemListEnd
      
      \resumeProjectHeading
        {\textbf{Airshine Online} $|$ \emph{\href{https://github.com/hruthiksiva/airshineonline}{\color{blue}GitHub}}}{April 22}
          \resumeItemListStart
